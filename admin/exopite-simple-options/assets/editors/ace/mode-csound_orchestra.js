ace.define("ace/mode/csound_preprocessor_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        ...
        this.$rules = {
            ...
            "macro body": [{
                token: "constant.character.escape.csound",
                regex: /\\#/
            }, {token: "punctuation.definition.macro.end.csound", regex: /#/, next: "start"}, e],
            ...
            return {
                regex: e.regex, onMatch: function (t, n, r, i) {
                    ...
                    if (Array.isArray(e.next)) {
                        var n = e.next[e.next.length - 1], r = n.length - 1, i = t.length - 1;
                        if (i > r) while (r >= 0 && i >= 0) {
    ...
    var r = e("../lib/oop"), i = e("./csound_preprocessor_highlight_rules").CsoundPreprocessorHighlightRules,
        s = function () {
            ...
            e.push({
                ...
                "loop after macro name": [e, this.popRule({
    ...
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        ...
        this.$rules = {
            ...
            qqstring3: [{token: "constant.language.escape", regex: m}, {
                token: "string",
                regex: '"{3}',
                next: "start"
            }, {defaultToken: "string"}],
            qstring3: [{token: "constant.language.escape", regex: m}, {
                token: "string",
                regex: "'{3}",
                next: "start"
            }, {defaultToken: "string"}],
            qqstring: [{token: "constant.language.escape", regex: m}, {
                token: "string",
                regex: "\\\\$",
                next: "qqstring"
            }, {token: "string", regex: '"|$', next: "start"}, {defaultToken: "string"}],
            qstring: [{token: "constant.language.escape", regex: m}, {
                token: "string",
                regex: "\\\\$",
                next: "qstring"
            }, {token: "string", regex: "'|$", next: "start"}, {defaultToken: "string"}]
        ...
        f = function () {
            ...
            n.splice(1, 0, {
                ...
                onMatch: function (n, r, i, s) {
                    var o = n.split(this.splitRegex), u = o[1], a;
                    return e.hasOwnProperty(u) ? a = "support.function.csound" : t.hasOwnProperty(u) && (a = "invalid.deprecated.csound"), a ? o[2] ? [{
                        type: a,
                        value: u
                    }, {
            ...
            this.embedRules(o, "csound-score-", i), this.embedRules(a, "python-", i), this.embedRules(u, "lua-", i), this.normalizeRules()
        };
