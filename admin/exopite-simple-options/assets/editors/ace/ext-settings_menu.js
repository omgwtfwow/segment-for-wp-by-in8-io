ace.define("ace/ext/menu_tools/overlay_page", ["require", "exports", "module", "ace/lib/dom"], function (e, t, n) {
...
}), ace.define("ace/ext/options", ["require", "exports", "module", "ace/ext/menu_tools/overlay_page", "ace/lib/dom", "ace/lib/oop", "ace/lib/event_emitter", "ace/ext/modelist", "ace/ext/themelist"], function (e, t, n) {
    "use strict";
    var r = e("./menu_tools/overlay_page").overlayPage, i = e("../lib/dom"), s = e("../lib/oop"),
        o = e("../lib/event_emitter").EventEmitter, u = i.buildDom, a = e("./modelist"), f = e("./themelist"),
        l = {Bright: [], Dark: []};
    ...
    (function () {
        s.implement(this, o), this.add = function (e) {
            e.Main && s.mixin(h.Main, e.Main), e.More && s.mixin(h.More, e.More)
        }, this.render = function () {
            this.container.innerHTML = "", u(["table", {id: "controls"}, this.renderOptionGroup(h.Main), ["tr", null, ["td", {colspan: 2}, ["table", {id: "more-controls"}, this.renderOptionGroup(h.More)]]]], this.container)
    ...
    function s(e) {
        if (!document.getElementById("ace_settingsmenu")) {
            var t = new r(e);
            t.render(), t.container.id = "ace_settingsmenu", i(e, t.container, "0", "0", "0"), t.container.querySelector("select,input,button,checkbox").focus()
        }
    }

    var r = e("ace/ext/options").OptionPanel, i = e("./menu_tools/overlay_page").overlayPage;
