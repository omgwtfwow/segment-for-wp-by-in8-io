...
class ActionScheduler_AdminView_Deprecated
{
	 ...
	 * custom columns for displaying those post fields. For the column content, @param array $columns An associative array of columns that are use for the table on the Scheduled Actions administration screen.
	 ...
	 * @see self::list_table_column_content().
	 *
	 */
